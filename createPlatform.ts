...
export const createPlatform = async () => {
  ...
  const { transaction, extInfo, execute } = await raydium.launchpad.createPlatformConfig({
    ...
    platformVestingWallet: PublicKey.default, // or just use PublicKey.default
    ...
    transferFeeExtensionAuth: PublicKey.default, // or just set owner
  ...
  try {
    console.log('execute function:', execute)
