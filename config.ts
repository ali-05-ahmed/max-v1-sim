...
//BsNvEvRZLRv2T8o5bpVyGHRZsTGQmCzsF8M4bVkAmfv3
export const owner: Keypair = Keypair.fromSecretKey(bs58.decode('5bwJhc5NjgUcbJGpfEtCJc6Ewsn4vT4RCfxejnYqQTjornWDB5JFwjZPWXyKbqKPRyChQN9NiQkCtYm5P5C4vg4j'))
export const connection = new Connection('https://solana-devnet.g.alchemy.com/v2/rahrAG37rgq4gQKI6NOgBxNZwXvl5mAE',{
  commitment: "confirmed"
}) //<YOUR_RPC_URL>
// export const connection = new Connection(clusterApiUrl('devnet')) //<YOUR_RPC_URL>
export const txVersion = TxVersion.V0 // or TxVersion.LEGACY
const cluster = 'devnet' as 'mainnet' | 'devnet' // 'mainnet' | 'devnet'
